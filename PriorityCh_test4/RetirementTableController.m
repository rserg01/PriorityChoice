...
#import "RetirementTableController.h"
...
@interface RetirementTableController ()

@end

@implementation RetirementTableController
...
{
    [self.navigationController.navigationBar.topItem setTitle:@"Retirement Products"];
